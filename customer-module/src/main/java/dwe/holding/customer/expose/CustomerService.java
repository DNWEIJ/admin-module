...
public class CustomerService {
    ...
    public Customer searchCustomer(Long customerId) {
        ...
        return customerMapper.toCustomer(
                customerRepository.findByIdAndMemberId(customerId, 77L) // TODO AutorisationUtils.getCurrentUserMid())
        );
    }

    public List<LookupSpecies> getSpecies() {
        return lookupSpeciesRepository.getList(77L); // todo AutorisationUtils.getCurrentUserMid
    }

    public List<LookupPurpose> getReasons() {
        return lookupPurposeRepository.getByMemberIdOrderByDefinedPurpose(77L); // todo AutorisationUtils.getCurrentUserMid;
    }
